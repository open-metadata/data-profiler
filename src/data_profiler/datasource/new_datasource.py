...
from data_profiler.datasource.data_connector import DataConnector
...
class BaseDatasource:
    ...
    def __init__(
        ...
        try:
            self._execution_engine = instantiate_class_from_config(
                ...
                runtime_environment={},
                config_defaults={"module_name": "data_profiler.execution_engine"},
            )
    ...
    def _build_data_connector_from_config(
        ...
        new_data_connector: DataConnector = instantiate_class_from_config(
            ...
            config_defaults={
                "module_name": "data_profiler.datasource.data_connector"
            },
        )
