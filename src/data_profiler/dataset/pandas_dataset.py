...
class MetaPandasDataset(Dataset):
    ...
    def column_map_expectation(cls, func):
        ...
        See :func:`column_map_expectation <data_profiler.data_asset.dataset.Dataset.column_map_expectation>` \
...
class PandasDataset(MetaPandasDataset, pd.DataFrame):
    """
PandasDataset instantiates the data_profiler Expectations API as a subclass of a pandas.DataFrame.
