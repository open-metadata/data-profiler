...
from data_profiler.core.evaluation_parameters import (
    _deduplicate_evaluation_parameter_dependencies,
    build_evaluation_parameters,
    find_evaluation_parameter_dependencies,
)
from data_profiler.core.urn import ge_urn
...
from data_profiler.expectations.registry import get_expectation_impl
    ...
    def get_evaluation_parameter_dependencies(self):
        ...
        for string_urn in urns:
            try:
                ...
                logger.warning(
                    "Unable to parse data_profiler urn {}".format(
                        value["$PARAMETER"]
                    )
                )
                continue
