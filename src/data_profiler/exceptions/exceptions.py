...
class ConfigNotFoundError(DataContextError):
    """The data_profiler dir could not be found."""

    def __init__(self):
        self.message = """Error: No data_profiler directory was found here!
    - Please check that you are in the correct directory or have specified the correct directory.
    - If you have never run Great Expectations in this project, please run `data_profiler init` to get started.
"""
        super().__init__(self.message)
