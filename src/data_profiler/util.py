...
from data_profiler.core.expectation_suite import expectationSuiteSchema
from data_profiler.exceptions import (
    GreatExpectationsError,
    PluginClassNotFoundError,
    PluginModuleNotFoundError,
)
from data_profiler.expectations.registry import _registered_expectations
...
def pluralize(singular_ge_noun):
    ...
    try:
        ...
        raise GreatExpectationsError(
            ...
            f"data_profiler.util.SINGULAR_TO_PLURAL_LOOKUP_DICT"
        )
...
def singularize(plural_ge_noun):
    ...
    try:
        ...
        raise GreatExpectationsError(
            ...
            f"data_profiler.util.PLURAL_TO_SINGULAR_LOOKUP_DICT."
        )
...
def import_library_module(module_name: str) -> Optional[ModuleType]:
    """
    :param module_name: a fully-qualified name of a module (e.g., "data_profiler.dataset.sqlalchemy_dataset")
...
def _convert_to_dataset_class(df, dataset_class, expectation_suite=None, profiler=None):
    """
    Convert a (pandas) dataframe to a data_profiler dataset, with (optional) expectation_suite
...
def read_csv(
    ...
    module_name="data_profiler.dataset",
    dataset_class=None,
    ...
    **kwargs,
    ...
    """Read a file using Pandas read_csv and return a data_profiler dataset.
    ...
    Args:
        ...
        expectation_suite (string): path to data_profiler expectation suite file
        profiler (Profiler class): profiler to use when creating the dataset (default is None)

    Returns:
        data_profiler dataset
    """
    import pandas as pd
...
def read_json(
    ...
    **kwargs,
    ...
    """Read a file using Pandas read_json and return a data_profiler dataset.
...
def read_excel(
    ...
    **kwargs,
    ...
    """Read a file using Pandas read_excel and return a data_profiler dataset.
    ...
    Returns:
        data_profiler dataset or ordered dict of data_profiler datasets,
...
def read_table(
    ...
    **kwargs,
    ...
    """Read a file using Pandas read_table and return a data_profiler dataset.
...
def read_feather(
    ...
    **kwargs,
    ...
    """Read a file using Pandas read_feather and return a data_profiler dataset.
...
def read_parquet(
    ...
    **kwargs,
    ...
    """Read a file using Pandas read_parquet and return a data_profiler dataset.
...
def from_pandas(
    ...
    """Read a Pandas data frame and return a data_profiler dataset.
    ...
    Args:
        ...
        dataset_class (Dataset): If specified, the class to which to convert the resulting Dataset object;
            if not specified, try to load the class named via the class_name and module_name parameters
        expectation_suite (string) = None: path to data_profiler expectation suite file
...
def read_pickle(
    ...
    **kwargs,
    ...
    """Read a file using Pandas read_pickle and return a data_profiler dataset.
...
def validate(
    ...
    data_asset_module_name="data_profiler.dataset",
    ...
    **kwargs,
    ...
    from data_profiler.dataset import Dataset, PandasDataset
...
def get_context():
    from data_profiler.data_context.data_context import DataContext
