...
import data_profiler.exceptions as exceptions
from data_profiler.core.util import nested_update
from data_profiler.data_context.store.html_site_store import (
    GeCloudIdentifier,
    HtmlSiteStore,
    SiteSectionIdentifier,
)
from data_profiler.data_context.store.json_site_store import JsonSiteStore
...
from data_profiler.render.util import resource_key_passes_run_name_filter
...
class SiteBuilder:
    ...
    DataContext's data_profiler.yml file.
    ...
    override renderers, views, and stores::
        ...
        local_site:
            ...
            # Verbose version:
            # site_index_builder:
            #     module_name: data_profiler.render.builder
            #     class_name: DefaultSiteIndexBuilder
            #     renderer:
            #         module_name: data_profiler.render.renderer
            #         class_name: SiteIndexPageRenderer
            #     view:
            #         module_name: data_profiler.render.view
            ...
            site_section_builders:
                ...
                validations:
                    module_name: data_profiler.data_context.render
                    class_name: DefaultSiteSectionBuilder
        ...
        **kwargs,
        ...
        for site_section_name, site_section_config in site_section_builders.items():
            ...
            module_name = (
                ...
                or "data_profiler.render.renderer.site_builder"
            )
            self.site_section_builders[
                site_section_name
...
class DefaultSiteSectionBuilder:
    def __init__(
        ...
        **kwargs,
        ...
        module_name = (
            renderer.get("module_name") or "data_profiler.render.renderer"
        )
