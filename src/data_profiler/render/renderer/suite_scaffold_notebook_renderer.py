...
from data_profiler.checkpoint import LegacyCheckpoint
from data_profiler.profile.user_configurable_profiler import UserConfigurableProfiler
from data_profiler.data_context.types.resource_identifiers import ValidationResultIdentifier
...
This can be done by running `data_profiler suite edit {self.suite_name}`."""
        )
