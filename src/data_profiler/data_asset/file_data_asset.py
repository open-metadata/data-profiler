...
class MetaFileDataAsset(DataAsset):
    ...
    def file_lines_map_expectation(cls, func):
        ...
        See also:
            ...
            <data_profiler.data_asset.base.DataAsset.expect_file_line_regex_match_count_to_be_between>` \
...
class FileDataAsset(MetaFileDataAsset):
    """
    FileDataset instantiates the data_profiler Expectations API as a
    subclass of a python file object. For the full API reference, please see
    :func:`DataAsset <data_profiler.data_asset.base.DataAsset>`
    """
