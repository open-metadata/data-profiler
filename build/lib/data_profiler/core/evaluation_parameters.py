...
from data_profiler.exceptions import EvaluationParameterError
...
def parse_evaluation_parameter(
    ...
    EXCEPT if they begin with the string "urn:data_profiler" in which case they may also include additional
