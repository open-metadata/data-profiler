...
from data_profiler import exceptions as ge_exceptions
...
from data_profiler.types.base import SerializableDotDict
...
def get_or_create_spark_application(
    ...
    if not name:
        name = "default_data_profiler_spark_application"
