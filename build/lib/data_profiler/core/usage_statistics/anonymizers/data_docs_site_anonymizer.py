...
from data_profiler.core.usage_statistics.anonymizers.site_builder_anonymizer import (
    SiteBuilderAnonymizer,
)
from data_profiler.core.usage_statistics.anonymizers.store_backend_anonymizer import (
...
class DataDocsSiteAnonymizer(Anonymizer):
    ...
    def anonymize_data_docs_site_info(self, site_name, site_config):
        ...
        if site_config_module_name is None:
            site_config[
                "module_name"
            ] = "data_profiler.render.renderer.site_builder"
