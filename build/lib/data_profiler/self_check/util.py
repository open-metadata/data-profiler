...
from data_profiler.core import (
...
from data_profiler.core.batch import Batch, BatchDefinition
...
from data_profiler.execution_engine.sparkdf_batch_data import SparkDFBatchData
from data_profiler.execution_engine.sqlalchemy_batch_data import (
    SqlAlchemyBatchData,
)
from data_profiler.profile import ColumnsExistProfiler
...
def candidate_test_is_on_temporary_notimplemented_list(context, expectation_type):
    ...
    if context in ["bigquery"]:
        return expectation_type in [
            ...
            "expect_column_pair_cramers_phi_value_to_be_less_than",
            "expect_multicolumn_sum_to_equal",
            "expect_column_values_to_be_between",  # TODO: error unique to bigquery -- https://github.com/great-expectations/data_profiler/issues/3261
            "expect_column_values_to_be_of_type",  # TODO: error unique to bigquery -- https://github.com/great-expectations/data_profiler/issues/3261
            "expect_column_values_to_be_in_set",  # TODO: error unique to bigquery -- https://github.com/great-expectations/data_profiler/issues/3261
            "expect_column_values_to_be_in_type_list",  # TODO: error unique to bigquery -- https://github.com/great-expectations/data_profiler/issues/3261
            "expect_column_values_to_match_like_pattern_list",  # TODO: error unique to bigquery -- https://github.com/great-expectations/data_profiler/issues/3261
            "expect_column_values_to_not_match_like_pattern_list",  # TODO: error unique to bigquery -- https://github.com/great-expectations/data_profiler/issues/3261
        ]
...
def candidate_test_is_on_temporary_notimplemented_list_cfe(context, expectation_type):
    ...
    if context == "bigquery":
        ...
        ###
        return expectation_type in [
            "expect_column_kl_divergence_to_be_less_than",  # TODO: Takes over 64 minutes to "collect" (haven't actually seen it complete yet) -- https://github.com/great-expectations/data_profiler/issues/3260
            "expect_column_values_to_be_in_set",  # TODO: No matching signature for operator and AssertionError: expected ['2018-01-01T00:00:00'] but got ['2018-01-01'] -- https://github.com/great-expectations/data_profiler/issues/3260
            "expect_column_values_to_be_in_type_list",  # TODO: AssertionError -- https://github.com/great-expectations/data_profiler/issues/3260
            "expect_column_values_to_be_between",  # TODO: "400 No matching signature for operator >=" -- https://github.com/great-expectations/data_profiler/issues/3260
            "expect_column_quantile_values_to_be_between",  # TODO: takes over 15 minutes to "collect" (haven't actually seen it complete yet) -- https://github.com/great-expectations/data_profiler/issues/3260
            "expect_column_mean_to_be_between",  # TODO: "400 No matching signature for operator *" -- https://github.com/great-expectations/data_profiler/issues/3260
            # "expect_select_column_values_to_be_unique_within_record",
            "expect_column_values_to_be_increasing",
            "expect_column_values_to_be_decreasing",
            "expect_column_values_to_match_strftime_format",
