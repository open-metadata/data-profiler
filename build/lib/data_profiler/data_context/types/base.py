...
from data_profiler.core.util import convert_to_json_serializable, nested_update
from data_profiler.marshmallow__shade import (
    INCLUDE,
    Schema,
    ValidationError,
    fields,
...
from data_profiler.marshmallow__shade.validate import OneOf
from data_profiler.types import DictDot, SerializableDictDot
from data_profiler.types.configurations import ClassConfigSchema
...
DEFAULT_USAGE_STATISTICS_URL = (
    "https://stats.greatexpectations.io/data_profiler/v1/usage_statistics"
)
...
class AssetConfigSchema(Schema):
    ...
    module_name = fields.String(
        required=False,
        all_none=True,
        missing="data_profiler.datasource.data_connector.asset",
    )
...
class SorterConfigSchema(Schema):
    ...
    module_name = fields.String(
        missing="data_profiler.datasource.data_connector.sorter"
    )
...
class DataConnectorConfigSchema(Schema):
    ...
    class_name = fields.String(required=True)
    module_name = fields.String(missing="data_profiler.datasource.data_connector")
...
class ExecutionEngineConfigSchema(Schema):
    ...
    class_name = fields.String(required=True)
    module_name = fields.String(missing="data_profiler.execution_engine")
...
class DatasourceConfig(DictDot):
    def __init__(
        self,
        class_name=None,
        module_name: Optional[str] = "data_profiler.datasource",
...
class DatasourceConfigSchema(Schema):
    ...
    module_name = fields.String(missing="data_profiler.datasource")
...
class NotebookConfigSchema(Schema):
    ...
    module_name = fields.String(
        missing="data_profiler.render.renderer.suite_edit_notebook_renderer"
    )
...
class CheckpointConfigSchema(Schema):
    ...
    module_name = fields.String(required=False, missing="data_profiler.checkpoint")
...
class CheckpointConfig(BaseYamlConfig):
    ...
    def __init__(
        ...
        self._module_name = module_name or "data_profiler.checkpoint"
        self._class_name = class_name
