...
from data_profiler._version import get_versions  # isort:skip

__version__ = get_versions()["version"]  # isort:skip
del get_versions  # isort:skip


from data_profiler.core import IDDict
...
from data_profiler.expectations.row_conditions import parse_condition_to_sqlalchemy
from data_profiler.util import filter_properties_dict, import_library_module
...
class SqlAlchemyExecutionEngine(ExecutionEngine):
    ...
    def get_domain_records(
        ...
        if (
            ...
            if condition_parser == "data_profiler__experimental__":
                ...
                raise GreatExpectationsError(
                    "SqlAlchemyExecutionEngine only supports the data_profiler condition_parser."
                )
...
""",
    ...
    def close(self):
        ...
        More background can be found here: https://github.com/great-expectations/data_profiler/pull/3104/
        """
