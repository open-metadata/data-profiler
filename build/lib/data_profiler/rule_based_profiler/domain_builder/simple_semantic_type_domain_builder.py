...
from data_profiler.profile.base import ProfilerTypeMapping
from data_profiler.rule_based_profiler.domain_builder import (
    Domain,
    DomainBuilder,
...
from data_profiler.validator.validator import MetricConfiguration
        ...
        inferred_semantic_column_type: InferredSemanticDomainType = (
            InferredSemanticDomainType(
                ...
                details={
                    ...
                    "source": "data_profiler.profile.base.ProfilerTypeMapping",
                },
            )
        )
