...
from data_profiler.checkpoint.util import (
    send_email,
    send_microsoft_teams_notifications,
    send_opsgenie_alert,
    send_slack_notification,
)
from data_profiler.data_context.store.metric_store import MetricStore
    ...
    .. code-block:: yaml
        ...
        action:
          ...
          renderer:
            ...
            # this is the default implementation, but you can
            # implement a custom one
            module_name: data_profiler.render.renderer.microsoft_teams_renderer
    ...
    .. code-block:: yaml
        ...
        action:
          ...
          renderer:
            ...
            # this is the default implementation, but you can
            # implement a custom one
            module_name: data_profiler.render.renderer.email_renderer
    ...
    **Configuration**
    ...
    .. code-block:: yaml
        ...
        action:
          ...
          # the name must refer to a store that is configured in the data_profiler.yml file
