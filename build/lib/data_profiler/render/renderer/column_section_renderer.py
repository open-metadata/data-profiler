...
from data_profiler.expectations.core.expect_column_kl_divergence_to_be_less_than import (
    ExpectColumnKlDivergenceToBeLessThan,
)
from data_profiler.expectations.registry import get_renderer_impl
from data_profiler.render.renderer.content_block import (
...
class ProfilingResultsColumnSectionRenderer(ColumnSectionRenderer):
    def __init__(self, properties_table_renderer=None, runtime_environment=None):
        ...
        module_name = "data_profiler.render.renderer.content_block"
