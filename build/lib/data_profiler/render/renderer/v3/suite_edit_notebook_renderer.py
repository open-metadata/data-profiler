...
from data_profiler.cli.batch_request import (
...
class SuiteEditNotebookRenderer(BaseNotebookRenderer):
    ...
    def __init__(
        ...
        loaders: list = custom_loader + [
            jinja2.PackageLoader(
                package_name="data_profiler.render.v3.notebook_assets",
    ...
    def from_data_context(data_context: DataContext):
        ...
        return instantiate_class_from_config(
            config={
                "module_name": "data_profiler.render.renderer.v3.suite_edit_notebook_renderer",
