...
from data_profiler.expectations.expectation import ColumnExpectation
...
class ExpectColumnQuantileValuesToBeBetween(ColumnExpectation):
    """Expect specific provided column quantiles to be between provided minimum and maximum values.
           ...
           See Also:
               ...
               <data_profiler.execution_engine.execution_engine.ExecutionEngine.expect_column_min_to_be_between>`

               :func:`expect_column_max_to_be_between \
               <data_profiler.execution_engine.execution_engine.ExecutionEngine.expect_column_max_to_be_between>`

               :func:`expect_column_median_to_be_between \
               <data_profiler.execution_engine.execution_engine.ExecutionEngine.expect_column_median_to_be_between>`
